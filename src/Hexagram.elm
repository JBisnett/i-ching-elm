module Hexagram exposing (Hexagram, hexagramList, parsedHexagrams, renderReading, toHtml)
...
hexagramList = 
  [ { number = 1
    ...
    , directName = "qián"
    , character = "䷀"
    , bars = [True, True, True, True, True, True]
  ...
  , { number = 3
    ...
    , directName = "zhūn"
    , character = "䷂"
    , bars = [False, True, False, False, False, True]
  ...
  , { number = 5
    ...
    , directName = "xū"
    , character = "䷄"
    , bars = [True, True, True, False, True, False]
  ...
  , { number = 6
    ...
    , directName = "sòng"
    , character = "䷅"
    , bars = [False, True, False, True, True, True]
    ...
    , lines = 
      ...
      , "To contend before him brings supreme good fortune.<Paste>"
  ...
  , { number = 7
    ...
    , directName = "shī"
    , character = "䷆"
    , bars = [False, True, False, False, False, False]
    , judgement = "The Army. The army needs perseverance and a strong man. Good fortune without blame."
    , image = "In the middle of the earth is water: The image of the Army. Thus the superior man increases his masses and generosity toward the people."
    , lines = 
  ...
  , { number = 8
    , name = "Grouping"
    , descriptor = "Holding Together"
    , directName = "bǐ"
    , character = "䷇"
    , bars = [False, False, False, False, True, False]
  ...
  , { number = 9
    ...
    , descriptor = "Small Taming"
    , directName = "xiǎo chù"
    , character = "䷈"
    , bars = [True, True, True, True, False, True]
  ...
  , { number = 10
    , name = "Treading"
    , descriptor = "Treading (Conduct)"
    , directName = "lǚ"
    , character = "䷉"
    , bars = [True, True, False, True, True, True]
  ...
  , { number = 11
    ...
    , directName = "tài"
    , character = "䷊"
    , bars = [True, True, True, False, False, False]
  ...
  , { number = 12
    , name = "Obstruction"
    , descriptor = "Standstill"
    , directName = "pǐ"
    , character = "䷋"
    , bars = [False, False, False, True, True, True]
  ...
  , { number = 13
    ...
    , directName = "tóng rén"
    , character = "䷌"
    , bars = [True, False, True, True, True, True]
    , judgement = "Fellowship with Men in the open. Success. It furthers one to cross the great water. The perseverance of the superior man furthers.<Paste>"
    , image = "Heaven and earth do not unite: The image of Standstill. Thus the superior man falls back upon his inner worth in order to escape the diffficulties. He does not permit himself to be honored with revenue."
    , lines = 
  ...
  , { number = 15
    ...
    , directName = "qiān"
    , character = "䷎"
    , bars = [False, False, True, False, False, False]
  ...
  , { number = 16
    , name = "Providing-For"
    , descriptor = "Enthusiasm"
    , directName = "yù"
    , character = "䷏"
    , bars = [False, False, False, True, False, False]
  ...
  , { number = 17
    ...
    , directName = "suí"
    , character = "䷐"
    , bars = [True, False, False, True, True, False]
  ...
  , { number = 18
    , name = "Corrupting"
    , descriptor = "Work on the Decayed"
    , directName = "gǔ"
    , character = "䷑"
    , bars = [False, True, True, False, False, True]
  ...
  , { number = 19
    ...
    , directName = "lín"
    , character = "䷒"
    , bars = [True, True, False, False, False, False]
  ...
  , { number = 20
    ...
    , directName = "guān"
    , character = "䷓"
    , bars = [False, False, False, False, True, True]
  ...
  , { number = 21
    , name = "Gnawing Bite"
    , descriptor = "Biting Through"
    , directName = "shì kè"
    , character = "䷔"
    , bars = [True, False, False, True, False, True]
  ...
  , { number = 22
    ...
    , directName = "bì"
    , character = "䷕"
    , bars = [True, False, True, False, False, True]
  ...
  , { number = 23
    , name = "Stripping"
    , descriptor = "Splitting Apart"
    , directName = "bì"
    , character = "䷖"
    , bars = [False, False, False, False, False, True]
  ...
  , { number = 24
    ...
    , directName = "fù"
    , character = "䷗"
    , bars = [True, False, False, False, False, False]
  ...
  , { number = 25
    ...
    , descriptor = "Innocence"
    , directName = "wú wàng"
    , character = "䷘"
    , bars = [True, False, False, True, True, True]
  ...
  , { number = 26
    ...
    , descriptor = "Great Taming"
    , directName = "dà chù"
    , character = "䷙"
    , bars = [True, True, True, False, False, True]
  ...
  , { number = 27
    , name = "Swallowing"
    , descriptor = "Mouth Corners"
    , directName = "yí"
    , character = "䷚"
    , bars = [True, False, False, False, False, True]
  ...
  , { number = 28
    ...
    , descriptor = "Great Preponderance"
    , directName = "dà guò"
    , character = "䷛"
    , bars = [False, True, True, True, True, False]
  ...
  , { number = 29
    , name = "Gorge"
    , descriptor = "The Abysmal Water"
    , directName = "kǎn"
    , character = "䷜"
    , bars = [False, True, False, False, True, False]
  ...
  , { number = 30
    , name = "Radiance"
    , descriptor = "The Clinging"
    , directName = "lí"
    , character = "䷝"
    , bars = [True, False, True, True, False, True]
  ...
  , { number = 31
    ...
    , directName = "xián"
    , character = "䷞"
    , bars = [False, False, True, True, True, False]
  ...
  , { number = 32
    ...
    , directName = "héng"
    , character = "䷟"
    , bars = [False, True, True, True, False, False]
  ...
  , { number = 33
    ...
    , directName = "dùn"
    , character = "䷠"
    , bars = [False, False, True, True, True, True]
  ...
  , { number = 34
    ...
    , descriptor = "Great Power"
    , directName = "dà zhuàng"
    , character = "䷡"
    , bars = [True, True, True, True, False, False]
  ...
  , { number = 35
    ...
    , directName = "jìn"
    , character = "䷢"
    , bars = [False, False, False, True, False, True]
  ...
  , { number = 36
    ...
    , descriptor = "Darkening of the Light"
    , directName = "míng yí"
    , character = "䷣"
    , bars = [True, False, True, False, False, False]
  ...
  , { number = 37
    ...
    , directName = "jiā rén"
    , character = "䷤"
    , bars = [True, False, True, False, True, True]
  ...
  , { number = 38
    , name = "Polarising"
    , descriptor = "Opposition"
    , directName = "kuí"
    , character = "䷥"
    , bars = [True, True, False, True, False, True]
  ...
  , { number = 39
    , name = "Limping"
    , descriptor = "Obstruction"
    , directName = "jiǎn"
    , character = "䷦"
    , bars = [False, False, True, False, True, False]
  ...
  , { number = 40
    , name = "Taking-Apart"
    , descriptor = "Deliverance"
    , directName = "xiè"
    , character = "䷧"
    , bars = [False, True, False, True, False, False]
  ...
  , { number = 41
    ...
    , directName = "sǔn"
    , character = "䷨"
    , bars = [True, True, False, False, False, True]
  ...
  , { number = 42
    ...
    , directName = "yì"
    , character = "䷩"
    , bars = [True, False, False, False, True, True]
  ...
  , { number = 43
    , name = "Parting"
    , descriptor = "Breakthrough"
    , directName = "guài"
    , character = "䷪"
    , bars = [True, True, True, True, True, False]
  ...
  , { number = 44
    , name = "Coupling"
    , descriptor = "Coming to Meet"
    , directName = "gòu"
    , character = "䷫"
    , bars = [False, True, True, True, True, True]
  ...
  , { number = 45
    , name = "Clustering"
    , descriptor = "Gathering Together"
    , directName = "cuì"
    , character = "䷬"
    , bars = [False, False, False, True, True, False]
    ...
    , image = "Over the earth, the lake: The image of Gathering Together. Thus the superior man renews his weapons in order to meet the unforseen."
    , lines = 
  ...
  , { number = 46
    , name = "Ascending"
    , descriptor = "Pushing Upward"
    , directName = "shēng"
    , character = "䷭"
    , bars = [False, True, True, False, False, False]
  ...
  , { number = 47
    , name = "Confining"
    , descriptor = "Oppression"
    , directName = "kùn"
    , character = "䷮"
    , bars = [False, True, False, True, True, False]
  ...
  , { number = 48
    ...
    , directName = "jǐng"
    , character = "䷯"
    , bars = [False, True, True, False, True, False]
  ...
  , { number = 49
    , name = "Skinning"
    , descriptor = "Revolution"
    , directName = "gé"
    , character = "䷰"
    , bars = [True, False, True, True, True, False]
  ...
  , { number = 50
    , name = "Holding"
    , descriptor = "The Cauldron"
    , directName = "dǐng"
    , character = "䷱"
    , bars = [False, True, True, True, False, True]
  ...
  , { number = 51
    ...
    , directName = "zhèn"
    , character = "䷲"
    , bars = [True, False, False, True, False, False]
  ...
  , { number = 52
    , name = "Bound"
    , descriptor = "The Keeping Still"
    , directName = "gèn"
    , character = "䷳"
    , bars = [False, False, True, False, False, True]
  ...
  , { number = 53
    ...
    , directName = "jiàn"
    , character = "䷴"
    , bars = [False, False, True, False, True, True]
  ...
  , { number = 54
    ...
    , descriptor = "The Marrying Maiden"
    , directName = "guī mèi"
    , character = "䷵"
    , bars = [True, True, False, True, False, False]
  ...
  , { number = 55
    , name = "Abounding"
    , descriptor = "Abundance"
    , directName = "fēng"
    , character = "䷶"
    , bars = [True, False, True, True, False, False]
  ...
  , { number = 56
    , name = "Sojourning"
    , descriptor = "The Wanderer"
    , directName = "lǚ"
    , character = "䷷"
    , bars = [False, False, True, True, False, True]
  ...
  , { number = 57
    , name = "Ground"
    , descriptor = "The Gentle"
    , directName = "xùn"
    , character = "䷸"
    , bars = [False, True, True, False, True, True]
  ...
  , { number = 58
    , name = "Open"
    , descriptor = "The Joyous"
    , directName = "duì"
    , character = "䷹"
    , bars = [True, True, False, True, True, False]
  ...
  , { number = 59
    ...
    , directName = "huàn"
    , character = "䷺"
    , bars = [False, True, False, False, True, True]
  ...
  , { number = 60
    ...
    , directName = "jié"
    , character = "䷻"
    , bars = [True, True, False, False, True, False]
  ...
  , { number = 61
    , name = "Centre Confirming"
    , descriptor = "Inner Truth"
    , directName = "zhōng fú"
    , character = "䷼"
    , bars = [True, True, False, False, True, True]
  ...
  , { number = 62
    ...
    , descriptor = "Small Preponderance"
    , directName = "xiǎo guò"
    , character = "䷽"
    , bars = [False, False, True, True, False, False]
  ...
  , { number = 63
    ...
    , descriptor = "After Completion"
    , directName = "jì jì"
    , character = "䷾"
    , bars = [True, False, True, False, True, False]
  ...
  , { number = 64
    ...
    , descriptor = "Before Completion"
    , directName = "wèi jì"
    , character = "䷿"
    , bars = [False, True, False, True, False, True]
